 ...
 * @version: 
 * @Author: 冉勇
 * @Date: 2021-02-25 23:37:50
 * @LastEditTime: 2021-03-06 11:33:47
 */

"ui";
context_DayOrNight = 1;
context_widthofTen = device.width / 10;  // 设备屏幕分辨率宽度
...
mainUi();  // 展示mainUI界面
if (getStorageData("ScriptIntroduce", "Zdddg") == undefined) {    // 读取本地数据
...
function mainUi() {
    ...
    ui.layout(
        ...
        <View bg="#FF4395FB" h="*" marginRight="63"/>//分割线颜色2   // 右外边距
