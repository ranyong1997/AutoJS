 ...
 * @version: 
 * @Author: 冉勇
 * @Date: 2021-02-23 16:29:14
 * @LastEditTime: 2021-02-23 20:21:01
 */
...
function dialogs_js() {
    ...
    if (i < 0) {
        ...
        if (Mute) {
            ...
            context_Mute = 1;   // context_Mute （0为开，1为关）
            toastLog("🔇已静音媒体音量");
        } else {
            context_Mute = 0;
        }
        ...
        toastLog(options_[i]);
        app.openUrl("https://wj.qq.com/s2/5238744/d982");   // 向作者反馈问题
        dialogs_js();
    } else if (i == 4) {
        toastLog(options_[i]);
