 ...
 * @version: 
 * @Author: 冉勇
 * @Date: 2021-12-20 17:02:18
 * @LastEditTime: 2021-12-20 17:02:18
 */
let debugWidget = function( widget, flag ){
    ...
    if( widget ){
        ...
        // widget.visibleToUser() ? log( "  " + prefix + flag + " " + widget.bounds() + " " + widget.id() + " " + widget.className() + " - " + widget.text() + " - " + widget.desc() + " - " + widget.checked() + " - " + widget.selected() + " - " + widget.clickable() + " - " + widget.visibleToUser() ) : ""
