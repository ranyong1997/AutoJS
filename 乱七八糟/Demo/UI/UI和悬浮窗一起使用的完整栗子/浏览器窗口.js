...
ui.layout(
  <vertical id="main" marginTop='0'  padding="10 10 10 30"   bg="#ff1e90ff">
    ...
    <horizontal layout_width="wrap_content" weightSum="5" >
      <button id="切换UA"  textSize="{{11}}"  layout_weight="1">切换UA</button>
      <button id="清除缓存"  textSize="{{11}}"  layout_weight="1">清除缓存</button>
      <button id="刷新"  textSize="{{11}}"  layout_weight="1">刷新</button>
      <button id="上一页"  textSize="{{11}}"  layout_weight="1">上一页</button>
      <button id="下一页"  textSize="{{11}}"  layout_weight="1">下一页</button>
    </horizontal>
    <horizontal>
      ...
      <frame layout_weight="1">
        <button id="关闭" textColor='#ff0000'>关闭</button>
      </frame>
      <frame layout_weight="1">
